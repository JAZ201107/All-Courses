...
class NDArray:
    ...
    def reshape(self, new_shape):
        ...
        return NDArray.make(
            new_shape, NDArray.compact_strides(new_shape), self._device, self._handle
        )
        ### END YOUR SOLUTION
    ...
    def __getitem__(self, idxs):
        ...
        for i, sl in enumerate(idxs):
            ...
            stop = sl.stop if sl.stop is not None else self._shape[i]
